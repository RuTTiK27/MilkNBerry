<%@ Page Title="Milk And Berries - Order Detail" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="orderDetail.aspx.cs" Inherits="orderDetail" %>
          ...
          <div class="card mb-4">
            <div class="card-body">
              <div class="mb-3 d-flex justify-content-between">
                ...
                <div class="d-flex">
                    <asp:Button ID="btnGetInvoice" CssClass="btn btn-link p-0 me-3 d-none d-lg-block btn-icon-text" OnClick="btnGetInvoice_Click" runat="server" Text="Invoice" />
                </div>
              </div>
                            ...
                            <td>
                              <div class="d-flex mb-2">
                                ...
                                <div class="flex-lg-grow-1 ms-3">
                                  <h6 class="small mb-0"><a href="https://milknberries.com/products.aspx?PNO=<%# Eval("PRODUCTNO") %>" class="text-reset"><%# Eval("NAME") %></a></h6>
